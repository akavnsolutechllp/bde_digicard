...
const Identity = () => {
    ...
    const brochureUrl = "https://akavnsolutechllp.github.io/bde_digicard/AKAVNBROCHURE.pdf";
    const servicesUrl = "https://akavnsolutechllp.github.io/bde_digicard/services.pdf";
